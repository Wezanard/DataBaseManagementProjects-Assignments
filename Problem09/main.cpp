...
void triangle()
{
	...
	cout << "The Perimeter is... " << length1*3 << endl;
}
void square()
{
    cout <<"Square!" << endl;
    ...
    cout << "The Area is ... " << area << endl;
	cout << "The Perimeter is... " << length1*4 << endl;
}
void pentagon()
{
    cout << "Pentagon!" << endl;
    ...
    cout << "The Area is ... " << area << endl;
	cout << "The Perimeter is... " << length1*5 << endl;
}
void hexagon()
{
    cout << "Hexagon!" << endl;
    ...
    cout << "The Area is ... " << area << endl;
	cout << "The Perimeter is... " << length1*6 << endl;
}
void heptagon()
{
    cout << "Heptagon!" << endl;
    ...
    cout << "The Area is ... " << area << endl;
	cout << "The Perimeter is... " << length1*7 << endl;
}
void octagon()
{
    cout << "Octagon!" << endl;
    ...
    cout << "The Area is ... " << area << endl;
	cout << "The Perimeter is... " << length1*8 << endl;
}
int main()
{
    int choice = 0;
